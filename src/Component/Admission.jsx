                ...
                <from action=""  className="space-y-5">
                 ...
                 items-center'>
                    ...
                    <div className='flex justify-center mt-20'>
                        <button type="submit" onClick={handleSubmit} className='px-10 py-3 text-xl hover:text-2xl text-white font-SptFont font-bold bg-red-800 hover:bg-red-600 rounded-2xl'>Submit</button>
                    </div>
                </from>
